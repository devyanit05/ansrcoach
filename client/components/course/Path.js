...
const Path = () => {
  ...
  const scrollListener = () => {
    steps.forEach((step) => {
      if (step.current) {
        if (window.innerHeight / 2 > step.current.getBoundingClientRect().top) {
        ...
        <div className={styles.container}>
          <div ref={steps[0]} className={[styles.step].join(" ")}>
            ...
            <div className={[styles.info, styles.right].join(" ")}>
              <h3>Diagnose</h3>
              <p>We diagnose and I dentify the students current needs</p>
            </div>
          </div>
          ...
          <div ref={steps[1]} className={styles.step}>
            <div className={[styles.info, styles.left].join(" ")}>
              <h3>Recommends</h3>
              <p>We recommend topics that are right for students</p>
            </div>
            <div className={styles.count}>
              <p>2</p>
            </div>
          ...
          <div ref={steps[2]} className={styles.step}>
            ...
            <div className={[styles.info, styles.right].join(" ")}>
              ...
              <p>
                Students choose and work through the topics at their own pace
              </p>
            </div>
          </div>
          ...
          <div ref={steps[3]} className={styles.step}>
            <div className={[styles.info, styles.left].join(" ")}>
              <h3>Practice</h3>
              <p>
                We supplement the in-class learning with targeted at home
                practice
              </p>
            </div>
            <div className={styles.count}>
